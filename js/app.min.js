...
function anchorLinks() {
  ...
  for (let t = 0; t < e.length; t++) {
    ...
    r.addEventListener("click", (e) => {
      e.preventDefault();
      const t = r.getAttribute("href").replace("#", ""),
        i = document.getElementById(t).getBoundingClientRect().top - n();
...
headerHandler(), isWebp(), anchorLinks(), lazyload();
